<template>
  <div class="hello">
    ...
    <div>
      <label>是否同意</label>
      <input type="checkbox" v-model="projectLeaderConfirmResult"/> {{projectLeaderConfirmResult}}
  ...
  export default {
    ...
    data() {
      return {
        ...
        task: {},
        projectLeaderConfirmResult: false
      }
    },
    mounted() {
      this.init();
        ...
        axios({
          ...
          data: {
            ...
            variables: [{
              ...
              value: this.projectLeaderConfirmResult,
              type: 'boolean'
            }]
          },
